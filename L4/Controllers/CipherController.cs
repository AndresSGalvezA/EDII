    ...
    public class CipherController : ControllerBase
    {
        ...
        public Task<IActionResult> DecipherCaesar([FromForm] CipherCaesarRequest DecipherCaesarRequest)
        {
            if (DecipherCaesarRequest.File.Length > 0)
            {
                ...
                CaesarCipher.Decipher(_environment.WebRootPath + "\\Cipher\\" + "Alphabet.txt", _environment.WebRootPath + "\\Decipher\\" + DecipherCaesarRequest.File.FileName, DecipherCaesarRequest.Key, _environment.WebRootPath + "\\Decipher\\" + DecipherCaesarRequest.Name + ".txt");
